...
GLOSSARY={
    ...
    "筑基丹":"đan dược Trúc Cơ","天道不公":"Thiên đạo bất công","不公":"bất công",
}
        ...
        for off in range(0,len(CASES),4):
            ...
            for x in batch:
                ...
                prompts.append(
                    ...
                    "5. 固定术语和整句术语必须优先采用上面的给定译法，不得扩写、同义改写或解释固定术语。\n"
                    "6. 短句保持简洁，不逐字硬译，不把术语扩写成解释；成语、讥讽、威胁和情绪要按越南语自然表达。\n"
                    "7. 只输出译文，不要解释、注释、免责声明或元话语。\n"
                    "〖待翻译文本〗\n"+x["source"]
                )
            chats=[
